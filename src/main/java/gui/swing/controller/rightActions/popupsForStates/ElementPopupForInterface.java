...
public class ElementPopupForInterface {
    ...
    public ElementPopupForInterface(Interclass ic, ArrayList<ClassContent> elementList, DiagramView dv) {
        ...
        addMButton.addActionListener(e -> {
            ...
            //panel.add(new JLabel("Type:"));
            //JComboBox<String> dataTypeComboBox = new JComboBox<>(new String[]{"public", "private", "protected"});
            //panel.add(dataTypeComboBox);

            panel.add(new JLabel(" Choose Input Types:"));
            String[] options = {"int", "string", "boolean", "char"};
            ArrayList<JCheckBox> checkBoxes = new ArrayList<>(); // Explicitly using ArrayList
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                ArrayList<String> selectedOptionsList = checkBoxes.stream()
                        ...
                        .collect(Collectors.toCollection(ArrayList::new)); // Explicitly using ArrayList

                String selectedOptions = String.join(", ", selectedOptionsList);

                if (!name.isEmpty()) {
                    //String resultString = operation + name + "("+ selectedOptions +") : " + dataType;
