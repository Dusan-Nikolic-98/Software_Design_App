...
public class GeneralizacijaPainter extends ElementPainter {
    private int[] currPos;
    public GeneralizacijaPainter(DiagramElement model) {
        super(model);
    ...
    private void drawArrowHead(Graphics2D g, int x1, int y1, int x2, int y2) {
        ...
        g.drawPolygon(new int[]{x2, x3, x4}, new int[]{y2, y3, y4}, 3);
    }
