...
@JsonTypeName("MyEnum")
public class MyEnum extends Interclass {
    public MyEnum(){
        setStartValues();
        this.setSubs(new ArrayList<>());
    }
    public MyEnum(String ime, ClassyNode parent) {
        super(ime, parent);
        setStartValues();
    }
    ...
    public void setContents(ArrayList<ClassContent> contents) {
        ...
        System.out.println("Element added or removed to/from ENUM contents list!");
